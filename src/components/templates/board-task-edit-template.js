const boardTaskEditTemplate = ({description, dueDate, tags, repeatingDays, currentColor, colors}) => {
  return `<article class="card card--edit card--${currentColor} ${Object.keys(
      repeatingDays).some((day) => repeatingDays[day]) ? `card--repeat` : ``}">
